    ...
    <footer className="bg-gray-900 text-white pt-20 pb-6">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap">
          ...
          <div className="w-full md:w-2/12 mb-10 md:mb-0">
            <h4 className="text-lg font-bold mb-5">Solutions</h4>
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-colors">Rotary Parking</a></li>
              <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-colors">Puzzle Parking</a></li>
              <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-colors">Pit Parking</a></li>
              <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-colors">Stack Parking</a></li>
              <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-colors">Custom Solutions</a></li>
            </ul>
          </div>
          ...
          <div className="w-full md:w-2/12 mb-10 md:mb-0">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-colors">News & Blog</a></li>
          ...
          <div className="w-full md:w-4/12">
            ...
            <p className="text-gray-400 mb-4">
              Subscribe to our newsletter to get the latest updates and news about our products.
            </p>
            <form className="flex">
              <input 
                type="email" 
          ...
          <div className="flex flex-wrap items-center">
            <div className="w-full md:w-8/12 mb-6 md:mb-0">
              <p className="text-gray-400 text-sm">
                © {new Date().getFullYear()} Spark Machineries Pvt Ltd. All rights reserved.
              </p>
            </div>
            <div className="w-full md:w-4/12">
              <ul className="flex justify-start md:justify-end space-x-6">
                <li><a href="#" className="text-gray-400 text-sm hover:text-purple-400 transition-colors">Privacy Policy</a></li>
                <li><a href="#" className="text-gray-400 text-sm hover:text-purple-400 transition-colors">Terms of Service</a></li>
              </ul>
            </div>
          </div>
        </div>
